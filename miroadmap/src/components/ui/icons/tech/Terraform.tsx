...
export const Terraform = ({ size = 24, className, color }: Props) => {
    return (
        <svg width={size} viewBox="-17.5 0 291 291" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
            <g>
